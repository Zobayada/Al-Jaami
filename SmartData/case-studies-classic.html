          ...
          <div class="col-sm-6 col-md-6 col-lg-4 mix filter-Support">
            <div class="portfolio-item">
              ...
              <div class="portfolio__content">
                ...
                <h4 class="portfolio__title mb-0"><a href="#">Financial’s Need For
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 mix filter-Consulting">
            <div class="portfolio-item">
              ...
              <div class="portfolio__content">
                ...
                <h4 class="portfolio__title mb-0"><a href="#">24x7 System Monitoring and
                    Alert Response</a></h4>
              </div><!-- /.portfolio-content -->
            </div><!-- /.portfolio-item -->
          </div><!-- /.col-lg-4 -->
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 mix filter-Security">
            <div class="portfolio-item">
              ...
              <div class="portfolio__content">
                ...
                <h4 class="portfolio__title mb-0"><a href="#">Nonprofit Organization
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 mix filter-Software">
            <div class="portfolio-item">
              ...
              <div class="portfolio__content">
                ...
                <h4 class="portfolio__title mb-0"><a href="#">Powerful IT Upgrade Aligns
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 mix filter-Management">
            <div class="portfolio-item">
              ...
              <div class="portfolio__content">
                ...
                <h4 class="portfolio__title mb-0"><a href="#">The Best IT Practices in Cloud
                    and Security</a></h4>
              </div><!-- /.portfolio-content -->
            </div><!-- /.portfolio-item -->
          </div><!-- /.col-lg-4 -->
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 mix filter-Cloud">
            <div class="portfolio-item">
              ...
              <div class="portfolio__content">
                ...
                <h4 class="portfolio__title mb-0"><a href="#">Helping Companies With
